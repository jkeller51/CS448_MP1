...
def find_storageLocs(maze):
      """Find all the places in maze where we should have boxes

      Args:
        maze(list): list of Node objects
      Returns storage(list): list of storage locations. 
      ...
      for line in maze:
          for char in line:
              if char.value  == ".":
                  storage.append(char) #this is a storage location
